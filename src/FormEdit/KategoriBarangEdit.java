 ...
 * @author rangg
 */
public class KategoriBarangEdit extends javax.swing.JFrame {
    String role = "";
    koneksi db = new koneksi();
    DefaultTableModel model = new DefaultTableModel();
    /**
     * Creates new form KategoriBarangEdit
     */
    public KategoriBarangEdit() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(customButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 430, 90, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KategoriBarangEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KategoriBarangEdit().setVisible(true);
            }
        });
    }
