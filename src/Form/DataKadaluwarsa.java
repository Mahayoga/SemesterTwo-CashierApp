 ...
 * @author rangg
 */
public class DataKadaluwarsa extends javax.swing.JFrame {
    String role = "";
    koneksi db = new koneksi();
    DefaultTableModel model = new DefaultTableModel();
    /**
     * Creates new form DataKadaluwarsa
     */
    public DataKadaluwarsa() {
        initComponents();
    ...
    private void initComponents() {
        ...
        customButton6.setText("customButton4");
        customButton6.setBackgroundColor(new java.awt.Color(0, 51, 255));
        ...
        jPanel1.add(customButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 570, 90, 40));

        customButton7.setText("customButton6");
        customButton7.setBackgroundColor(new java.awt.Color(255, 102, 102));
        customButton7.setFontSize(14);
        customButton7.setTextBold(1);
        customButton7.setTextColor(java.awt.Color.white);
        customButton7.setTheText("Hapus");
        jPanel1.add(customButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 570, 90, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataKadaluwarsa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataKadaluwarsa().setVisible(true);
            }
        });
    }
